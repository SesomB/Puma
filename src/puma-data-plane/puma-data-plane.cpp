...
PumaDataPlane::PumaDataPlane(Configuration& configuration,pcpp::DpdkDevice *device, int rxQueueId) : m_Configuration(configuration),m_Device(device), m_RxQueueId(rxQueueId), m_KeepRunning(false), m_CoreId(MAX_NUM_OF_CORES + 1)
{
}
